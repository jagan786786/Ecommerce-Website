                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?= base_url() ?>Product/registerProduct"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" name="product_brand" class="form-control form-control-user"
                                            id="product_brand" placeholder="Product Brand">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div>Product Summary</div>
                                    <textarea class="form-control form-control-user" id="product_summary"
                                        name="product_summary" placeholder="Product Summary"></textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-2 mb-3 mb-sm-0">
                                        ...
                                        <?php echo form_error('product_cost_price'); ?>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="product_osffer"
                                            name="product_offer" placeholder="Product Offer">
                                        <?php echo form_error('product_offer'); ?>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-6 mb-6 mb-sm-0">
                                        <div class="center">
                                            <div class="form-input">
                                                ...
                                                <input type="file" name="uploadimage" id="file-ip-1" accept="image/*"
