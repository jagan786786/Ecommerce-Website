        ...
        <div class="col product_section clearfix">
            ...
            <div class="breadcrumbs d-flex flex-row align-items-center">
                <ul>
                    ...
                    <li class="active"><a href="<?= base_url() ?>"><i class="fa fa-angle-right"
                                        ...
                                        <div class="product-item men">
                                            <div class="product discount product_filter">
                                                <div class="product_image">
                                                    <img src="<?php echo base_url(); ?>/assets/images/<?php echo htmlentities($row->product_image) ?>"height="200" width="300"
                                                        alt="">
                                                </div>
                                                ...
                                                <div class="product_info">
                                                    <h6 class="product_name"><a
                                                            href="<?= base_url() ?>Product/Productdetails/<?php echo htmlentities($row->product_id) ?>"><?php echo htmlentities($row->product_name) ?></a></h6>
                                                    <div class="product_price">INR
                                                        <?php echo htmlentities($row->product_marginal_price) ?><span>INR
                                                            <?php echo htmlentities($row->product_selling_price) ?>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="red_button add_to_cart_button"><a href="<?php echo base_url(); ?>Product/Productdetails">Buy now</a></div> -->
                                        	
                                            <span class="red_button add_to_cart_button"><a href="#">add to cart</a></span>
                                        </div>
                                        <?php $cnt++;
                                    } // end foreach
                                } else { ?>
